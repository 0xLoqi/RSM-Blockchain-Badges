...
const badges = [
  ...
  { name: "Smart Contract Expert", description: "Mastered Solidity programming", image: "https://imgur.com/a/qfsJvOO.gif", date: "2024-02-28" },
  ...
  { name: "Blockchain Pioneer", description: "Completed first transaction on Base", image: "https://imgur.com/a/qfsJvOO.gif", date: "2023-12-05" },
        ...
        {badges.map((badge, index) => (
          ...
          >
            ...
            <CardContent className="flex flex-col items-center">
              <img src={badge.image} alt={badge.name} className="w-32 h-32 object-contain mb-4" />
